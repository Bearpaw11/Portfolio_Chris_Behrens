        ...
        <Slider {...settings}>
          ...
          <Card clasName="card"style={{ width: '400px', height: '620px' }}>
           ...
           <Card.Body>
             ...
             <Card.Text>This app allows you to practice your speech using voice-to-text technology. You will receive analysis on filler words you might be saying and the length of your speech. </Card.Text>
          ...
          <Card style={{ width: '400px', height: '620px' }}>
           ...
           <Card.Body>
             ...
             <Card.Text>This is Full Stack social media app aimed at those who have an interest in consuming adult libations, whether at home or out and about, painting the town red! </Card.Text>
